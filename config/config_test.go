...
func TestRunMode(t *testing.T) {
	tests := []struct {
		...
		{sections: []string{"http1.1", "http1.1/5.1.2/1"}, target: "http1.1", mode: RunModeAll},
		{sections: []string{"http1.1", "http1.1/5.1.2/1"}, target: "http1.1/5", mode: RunModeAll},
		{sections: []string{"http1.1", "http1.1/5.1.2/1"}, target: "http1.1/5.1", mode: RunModeAll},
		{sections: []string{"http1.1", "http1.1/5.1.2/1"}, target: "http1.1/5.1.2", mode: RunModeAll},
		{sections: []string{"http1.1", "http1.1/5.1.2/1"}, target: "http1.1/5.1.2/1", mode: RunModeAll},
		{sections: []string{"http1.1", "http1.1/5.1.2/1"}, target: "http1.1/4", mode: RunModeAll},
		{sections: []string{"http1.1", "http1.1/5.1.2/1"}, target: "http1.1/5.2", mode: RunModeAll},
		{sections: []string{"http1.1", "http1.1/5.1.2/1"}, target: "http1.1/5.1.3", mode: RunModeAll},
		{sections: []string{"http1.1", "http1.1/5.1.2/1"}, target: "http1.1/5.1.2/2", mode: RunModeAll},
	}
